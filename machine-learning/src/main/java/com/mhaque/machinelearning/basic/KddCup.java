/**
 * Created by @authoer haquem on Dec 26, 2019 
 */
package com.mhaque.machinelearning.basic;
...
public class KddCup {
	...
	public static void main(String args[]) throws Exception {
		...
		EnsembleLibrary.saveLibrary(new File("src/main/resourcesensembleLib.model.xml"), ensembleLib, null);
		...
		ensambleSel.setOptions(new String[]{
				 "-L", "src/main/resourcesensembleLib.model.xml", // </path/to/modelLibrary> - Specifies the Model Library File, continuing the list of all models.
				 "-W", "src/main/resourcesesTmp", // </path/to/working/directory> - Specifies the Working Directory, where all models will be stored.
	...
	public static double[] evaluate(Classifier model) throws Exception {
		...
		for (int i = 0; i < labelFiles.length; i++) {
			...
			// Load data
			Instances train_data = loadData("src/main/resourcesorange_small_train.data",
											"src/main/resourcesorange_small_train_" + labelFiles[i]+ ".labels.txt");
